...
4. ИСПРАВЬ ИМЕНА АДМИНИСТРАТОРОВ к стандартным вариантам:
   ...
   - "Наташа" → "Наталья"
   - "Настя" → "Анастасия"
   - ВАЖНО: Whisper может неправильно распознать женские имена на "а":
     * "Леонид" (мужское) часто ошибка вместо "Алёна" (женское)
     * "Леонид" в контексте женского голоса/администратора → исправь на "Алёна"
...
5. Классифицируй звонок:
   ...
   - clinic_address: "адрес медцентра" (если упомянут - нормализуй к стандартному варианту из списка)

ПРИМЕРЫ:

Входная транскрипция: "Здравствуйте, меня зовут Иванов Сергей Петрович, мой телефон 89501234567, мне 45 лет. Хочу записаться на услугу по адресу улица Примерная 25. Оператор Мария мне говорила, что цена 3500 рублей."

Результат: "Здравствуйте, меня зовут [ФИО], мой телефон [ТЕЛЕФОН], мне 45 лет. Хочу записаться на услугу по адресу улица Примерная 25. Оператор Мария мне говорила, что цена 3500 рублей."
