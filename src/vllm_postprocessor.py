...
VLLM_SYSTEM_PROMPT_TEMPLATE = """Ты - эксперт по обработке транскрипций звонков в сети клиник МРТ-Лидер.
...
3. НЕ МАСКИРУЙ (критично для анализа):
   ...
   - Цифры: цены, вес, рост, возраст (оставляй как есть)
   - Даты и время визита (оставляй как есть)
...
Результат: "Здравствуйте, меня зовут [ФИО], мой телефон [ТЕЛЕФОН], мне 45 лет, вес 85 килограмм. Хочу записаться на МРТ на улицу Ленина 25. Администратор Алёна мне говорила, что цена 3500 рублей."
