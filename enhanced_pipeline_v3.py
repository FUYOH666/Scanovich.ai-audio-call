        ...
        for line in lines:
            ...
            if (not line or 
                any(skip_phrase in line for skip_phrase in [
                    ...
                    '===', '====', 'медицинский центр', 'Сеть клиник', 'Автор:', 
            ...
            if '[' in line and 's]' in line and ':' in line:
                ...
                if match:
                    ...
                    if text:
                        ...
                        if any(admin_word in text.lower() for admin_word in ['администратор', 'добрый день', 'медицинский центр', 'могу помочь', 'как вас зовут']):
