...
class TranscriptionPostProcessor:
    ...
    def __init__(self):
        ...
        self.clinic_corrections = {
            # РЕАЛЬНЫЕ ОШИБКИ ИЗ ТРАНСКРИПЦИЙ:
            "марта лидер": "медицинский центр",
            "санта-диагностика": "центр диагностики",
            
            # Дополнительные варианты
            "варфаламеева": "Варфоломеева",
            "варфоломева": "Варфоломеева",
            "варфаломева": "Варфоломеева",
            "мэрт лидер": "медицинский центр",
            "мэрти лидер": "медицинский центр",
            "эмэрт лидер": "медицинский центр",
            "мерт лидер": "медицинский центр",
