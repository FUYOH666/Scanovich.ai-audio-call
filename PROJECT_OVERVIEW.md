...
**Важно:** в репозитории — **демонстрационная / референсная конфигурация** под конкретный класс телефонии (язык, качество записи, домен). Это не «одинаково точная» транскрипция любых файлов на планете: качество зависит от модели ASR, языка, шума и кодека. Под другой язык или другой профиль аудио нужна индивидуальная настройка — можно написать: см. [FUNDING.md](FUNDING.md), `iamfuyoh@gmail.com`, [@ScanovichAI](https://t.me/ScanovichAI). Подробнее по-английски: [README.md](README.md#important-this-is-a-demonstration-configuration).
